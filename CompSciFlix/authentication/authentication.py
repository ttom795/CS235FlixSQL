...
import CompSciFlix.authentication.services as services
...
def login():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            password_does_not_match_username = 'Invalid password - please check and try again'
...
class PasswordValid:
    def __init__(self, message=None):
        if not message:
            message = 'Your password must have at least 8 characters, an upper case letter, a lower case letter and a digit.'
